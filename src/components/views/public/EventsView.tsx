  ...
  return (
    <div className="space-y-8 pb-16 animate-ios-fade-in">
      ...
      <div className="space-y-6">
        {events.map((evt) => (
          <IOSCard key={evt.id} className="overflow-hidden p-0 border border-zinc-200/80 dark:border-zinc-800/80">
              ...
              <div className="md:col-span-2 p-6 sm:p-8 space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <div className="pt-1 text-xs">
                    <strong className="text-zinc-900 dark:text-white">Speakers: </strong>
                    <span className="text-zinc-600 dark:text-zinc-400">{evt.speakers.join(', ')}</span>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-amber-500 hover:bg-amber-400 text-zinc-950 font-bold text-xs shadow-md transition-all ios-active"
                  >
                    Register for Event
                  </button>
                </div>
      ...
      >
        {registered ? (
          <div className="text-center py-8 space-y-4">
            <div className="w-16 h-16 rounded-full bg-green-500/20 text-green-500 flex items-center justify-center mx-auto text-3xl">
